<?php
    ...
    fputcsv($out, array('Faculty Name','Employee Type','Request Hrs', 'Approved Hrs', 'Request Amount', 'Approved Amount'));
    // Write all the user records to the spreadsheet
    foreach($data as $row)
    {
        fputcsv($out, array($row['FacultyName'], $row['Employee'], $row['RequestHrs'], $row['ApprovedHrs'], $row['RequestAmount'], $row['ApprovedAmount']));
    }
